...
public class FlightManagementServletRest extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getSession().setAttribute("emptySeatsREST", emptySeats);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getSession().setAttribute("occupiedSeatsREST", ocuppiedSeats);
        response.sendRedirect("integrationrest.jsp");
        response.setStatus(200);
    }
