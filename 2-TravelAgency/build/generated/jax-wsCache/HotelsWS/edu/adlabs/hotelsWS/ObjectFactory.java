 ...
 * generated in the edu.adlabs.hotelsWS package. 
...
public class ObjectFactory {
    ...
    private final static QName _ConsultaLibres_QNAME = new QName("http://hotels.adlabs.edu/", "consulta_libres");
    private final static QName _ConsultaLibresResponse_QNAME = new QName("http://hotels.adlabs.edu/", "consulta_libresResponse");
    private final static QName _ReservaHabitacion_QNAME = new QName("http://hotels.adlabs.edu/", "reserva_habitacion");
    private final static QName _ReservaHabitacionResponse_QNAME = new QName("http://hotels.adlabs.edu/", "reserva_habitacionResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: edu.adlabs.hotelsWS
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://hotels.adlabs.edu/", name = "consulta_libres")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://hotels.adlabs.edu/", name = "consulta_libresResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://hotels.adlabs.edu/", name = "reserva_habitacion")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://hotels.adlabs.edu/", name = "reserva_habitacionResponse")
