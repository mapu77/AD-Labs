...
public interface HotelsWS {
    ...
    @RequestWrapper(localName = "reserva_habitacion", targetNamespace = "http://hotels.adlabs.edu/", className = "edu.adlabs.hotelsWS.ReservaHabitacion")
    @ResponseWrapper(localName = "reserva_habitacionResponse", targetNamespace = "http://hotels.adlabs.edu/", className = "edu.adlabs.hotelsWS.ReservaHabitacionResponse")
    ...
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "consulta_libres", targetNamespace = "http://hotels.adlabs.edu/", className = "edu.adlabs.hotelsWS.ConsultaLibres")
    @ResponseWrapper(localName = "consulta_libresResponse", targetNamespace = "http://hotels.adlabs.edu/", className = "edu.adlabs.hotelsWS.ConsultaLibresResponse")
