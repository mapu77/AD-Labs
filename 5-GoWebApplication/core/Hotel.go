...
func newHotel(id int, name string, chain string, rooms integer, street string, number integer, zipcode string, city string, province string, country string) *Hotel {
...
func persist(hotel *Hotel) error {
	return nil
}